...
namespace Skele_lib {
	namespace SKGE {
		namespace GameObject {
			...
			class Player {
				Sprite m_sprite;
				Vector::Vec2d m_size, m_force, m_scale, m_drag;
				Vector::Vec2i m_position;
				int	m_score;
			public:
				Player() {
					m_sprite = Sprite();
				...
				Player(const char* path, SDL_Renderer* renderer, Vector::Vec2d _s, Vector::Vec2i _p, Vector::Vec2d _d) {
				...
				Vector::Vec2i& GetPosition() { return m_position; }
